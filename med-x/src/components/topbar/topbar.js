...
const Topbar = () => {
    return (
        ...
        <div className="w-[1024px] h-[92px] justify-center items-center gap-5 inline-flex">
            ...
            <div className="px-5 py-[21px] bg-neutral-900 rounded-[100px] justify-center items-center gap-2.5 flex">
            ...
            <div className="rounded-[10px] justify-start items-center gap-2.5 flex">
                <div className="justify-start items-center gap-2.5 flex">
                    <div className="w-[90px] h-[90px] bg-black bg-opacity-30 rounded-full shadow-inner" />
                </div>
            </div>
        </div>
