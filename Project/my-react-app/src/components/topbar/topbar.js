...
const Topbar = () => {
    return (
        <div className="w-full h-[90px] justify-between items-center inline-flex p-3 gap-1">
        <div  className="grow shrink basis-0 self-stretch  flex-col justify-start items-start gap-2.5 inline-flex ">
            <div className="self-stretch grow shrink basis-0 bg-neutral-900 rounded-[10px] justify-between items-center inline-flex p-5">
